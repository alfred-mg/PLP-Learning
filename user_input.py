...
# location and then prints out a personalized message.
...
# and store it in a variable called "location".
location = input('Where do you live?')


# Print out a personalized message using the user's name, age, 
# and location. For example: "Hello [name], you are [age] years 
# old and live in [location]."
